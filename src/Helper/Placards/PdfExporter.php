...
class PdfExporter {
    ...
    public function __construct($fontDirectory, $version) {
    ...
    public function getPdf(Placard $placard) {
        if(!defined('FPDF_FONTPATH')) {
            define('FPDF_FONTPATH', $this->fontDirectory);
        }
        ...
        $pdf->AddFont('SegoeUI','R', 'segoeui.php');
        $pdf->AddFont('SegoeUI','B', 'segoeuib.php');

        $pdf->setFont('SegoeUI', 'R', 32);
